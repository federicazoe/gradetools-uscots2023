...
Each row in the data set is an observation and has information about a baby and their parents. There are 1210 rows and 22 variables.
...
Explanatory is age and response is weight.

```{r}
ggplot(babies, aes(x = age, y = wt)) +
  geom_point() +
  xlab("Mother's age") +
...
```{r echo = FALSE}
knitr::include_graphics("question-plot.png")
```

**Answer**

I could not get this plot to show and I do not know why. It says it could not find the file but I have it saved in the same folder. Can I get an extension please?
